...
if (isset($_POST["email"])) {
    ...
    try {
        ...
        // Recipients
        $mail->setFrom('lorem.ipsum.sample.email@gmail.com', 'Abhishek Thakour');
        $mail->addAddress($_POST["email"]);
        $mail->addReplyTo('lorem.ipsum.sample.email@gmail.com', 'Abhishek Thakour');
        ...
        echo "
            ...
            document.location.href = 'Travelling.html';
            </script>
        ";
    } catch (Exception $e) {
